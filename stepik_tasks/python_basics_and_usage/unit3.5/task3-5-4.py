...
В этой задаче вам необходимо воспользоваться API сайта https://www.artsy.net/
...
к API https://developers.artsy.net/v2/start и выполнить необходимые шаги, а именно зарегистрироваться,
...
client_id = '6ec1ceb14267574c1cbc'
client_secret = '1e673f61bb660893eee46d6ec0bc9614'
...
for artist_id in id_list:
    api_url = 'https://api.artsy.net/api/artists/' + artist_id

    res = requests.get(api_url, headers=headers)
    data = res.json()
    result_list.append(str(data['birthday']) + data['sortable_name'])

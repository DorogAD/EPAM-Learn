...
Pay attention, index counting starts from 0, not from 1. Which means that if you need to get the first element
from the array elements, you should do elements[0], and the second element is elements[1].
...
def easy_unpack(elements: tuple) -> tuple:
    new = (elements[0], elements[2], elements[-2])
    return new
